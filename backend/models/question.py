...
class Question:
    ...
    def _single_parse_video_mme(question_dict):
        """
        Parses a single question dictionary from Video-MME into a Question object.
    ...
    def parse_video_mme(questions_arr: List[dict]):
        """
        Parses a list of question dictionaries from Video-MME and returns a list of Question objects.
        ...
        """
        return [
            Question._single_parse_video_mme(question_dict)
